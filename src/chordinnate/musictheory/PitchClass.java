...
public enum PitchClass implements Enharmonic<PitchClass>, Diatonic {
    ...
    private final EnharmonicSpelling ENHARMONIC_SPELLING;
    private final int BASE_MIDI_VALUE;
    private final Octave OCTAVE_RANGE;
    ...
    public EnharmonicSpelling getEnharmonicSpelling() {
        return ENHARMONIC_SPELLING;
    }
    ...
    public boolean hasAccidental(Accidental accidental) {
        return this.ENHARMONIC_SPELLING.getAccidental().equals(accidental);
    }
