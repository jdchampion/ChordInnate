...
public enum Pitch
    ...
    private String getFullName() {
        return PITCH_CLASS.ENHARMONIC_SPELLING.NAME + OCTAVE;
    }
    ...
    public Pitch transposeTo(@NotNull Interval interval, boolean direction) {
        if (isTransposableTo(interval, direction)) {
            ...
            int enharmonicIndex = direction
                    ? (idx + interval.getSemitones()) % 12
                    : (idx + 12 * interval.getOctaves() - interval.getSemitones()) % 12;
            ...
            for (int i = 0; i < candidates.length; i++) {
                ...
                int curDistanceRight = (7 - (expectedLetterIndex - candidateLetterIndex)) % 7;
                int curDistanceLeft =  (7 - (candidateLetterIndex - expectedLetterIndex)) % 7;
                int currentDistance = Math.min(curDistanceLeft, curDistanceRight);
            ...
            if (interval.isCompound()) {
                ...
                int octaveSpan = interval.getOctaves();
