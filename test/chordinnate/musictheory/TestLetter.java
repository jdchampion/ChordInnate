...
public class TestLetter {
    ...
    @Test
    public void getVectorDistanceTo() {
        // Same letter should always return 0, regardless of direction
        assertEquals(0, Letter.C.getVectorDistanceTo(Letter.C, true));
        assertEquals(0, Letter.C.getVectorDistanceTo(Letter.C, false));

        // Moving by 1 unit
        assertEquals(1, Letter.C.getVectorDistanceTo(Letter.D, true));
        assertEquals(-1, Letter.C.getVectorDistanceTo(Letter.B, false));
        assertEquals(1, Letter.F.getVectorDistanceTo(Letter.G, true));
        assertEquals(-1, Letter.F.getVectorDistanceTo(Letter.E, false));
        assertEquals(1, Letter.B.getVectorDistanceTo(Letter.C, true));
        assertEquals(-1, Letter.B.getVectorDistanceTo(Letter.A, false));
    }
